...
response1, impedance1, power1, spl1 = enclosure1.calculate_bass_reflex_response(frequencies , number_of_speakers=1)
response2, impedance2, power2, spl2 = enclosure2.calculate_bass_reflex_response(frequencies , number_of_speakers=2)
response3, impedance3, power3, spl3 = enclosure3.calculate_bass_reflex_response(frequencies , number_of_speakers=3)
response4, impedance4, power4, spl4 = enclosure4.calculate_bass_reflex_response(frequencies , number_of_speakers=4)
